<template>
    <div class="login">
        <header class="header">
            <span class="back" @click="toMe"><i class="iconfont icon-xiangzuojiantou"></i></span>
            <h1>登录717</h1>
            <span class="more" @click="toRegister">注册</span>
        </header>
        <section class="scroll">
            <ul>
                ...
                <li>
                    ...
                    <p><input type="password"   placeholder="请输入您的密码" v-model.trim="password"></p>
                    
                    </li>
            </ul>
            <div class="loginBut">
                <p><button @click="loginBut">登录</button></p>
